...
aa.env.setValue("emailTemplate", "PERMITS ABOUT TO EXPIRE");
aa.env.setValue("daySpan", "2");
aa.env.setValue("lookAheadDays", "29");
aa.env.setValue("skipAppStatus","Finaled,Closed,Void,Withdrawn,Finaled CO Issued");
*/
...
function mainProcess() {
	...
	for (myCapsXX in myCaps) {
		...
		var conTypeArray = new Array(); conTypeArray.push("Applicant");
		...
		for (thisCon in conArray) {
			...
			if (conEmail) {
				...
				addParameter(emailParameters,"$$expirationDate$$",getAppSpecific("Permit Expiration Date"));
				var capId4Email = aa.cap.createCapIDScriptModel(capId.getID1(),capId.getID2(),capId.getID3());
				var fileNames = [];
				aa.document.sendEmailAndSaveAsDocument("no-reply@accela.com",conEmail,"" , emailTemplate, emailParameters, capId4Email, fileNames);
